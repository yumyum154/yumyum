...
<div class=" page-container">
    ...
    <main>
        ...
        <section class="company cow">
            <video src="/readywears/asset/video/ledge.mp4" autoplay muted loop playsinline type="video/mp4"
                class="background-video"></video>
            <div class="video-overlay"></div>
            <div class="container-large">
                <div class="company-row">
                    <div class="company-col">
                        <h1 class="title">Leger</h1>
                        <p>Leger is also part of our Sherbrooke operations and provides high hashrate production...</p>
