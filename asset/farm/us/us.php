...
<div class=" page-container">
    ...
    <main>
        <div class="governance-header">
            ...
            <nav>
                <ul id="gov_header">
                    <li><a href="/readywears/asset/farm/us/us.php">united state</a></li>
                    <li><a href="/readywears/asset/farm/us/sharon.php">sharon</a></li>
                    <li><a href="/readywears/asset/farm/us/washington.php">washington</a></li>
                </ul>
            </nav>
        </div>
        <section class="company can">
                    ...
                    <div class="company-col">
                        ...
                        <div class="company-content">
                            ...
                            <div>
                                ...
                                <h5>1</h5>
                                <p>Data Centers in Operation</p>
                            </div>

                            <div>
                                <img src="../../svgs/EHs_white.svg" alt="">
                                <h5>32</h5>
                                <p>EH/s</p>
                            </div>
                        </div>
